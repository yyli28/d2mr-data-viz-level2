...
The plot used geom_point() to visualize individual data points and geom_smooth() to display overall trends within each gender category. The aes() function maps height_cm to the x-axis and mass to the y-axis. The The layer order is important - points should be plotted first, followed by regression lines.
...
ggplot(sw.viz, aes(x = height_cm, y = mass)) +
  ...
  theme(
    ...
    axis.title = element_text(family = "Comic Sans MS"),      # Change font type 
